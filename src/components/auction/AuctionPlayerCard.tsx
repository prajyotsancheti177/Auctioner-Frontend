...
export const AuctionPlayerCard = ({ player, isAnimated, isSold, className }: PlayerCardProps) => {
  ...
  return (
    <div
      className={cn(
        "relative overflow-hidden rounded-2xl bg-card/60 border-2 border-border shadow-elevated transition-all w-full",
    ...
    >
      {/* Player Image */}
      <div className="relative flex-shrink-0 w-36 h-56 md:w-44 md:h-64 overflow-hidden rounded-l-2xl">
        <img
          src={logoSrc}
          alt={player.name}
  ...
  {/* Player Details */}
  <div className="p-3 flex-1 w-full md:pl-6">
        {/* Glass panel for details */}
        <div className="w-full h-full bg-white/6 backdrop-blur-sm p-3 md:p-6 rounded-r-2xl">
